...
<template>
  <VDialog v-model="isDialogVisible" width="500">
    ...
    <!-- Dialog Content -->
    <VCard title="전자서명(거래원장 전자서명일 때)">
      <VCardText>
        <AppTextField label="서명이름" placeholder="등록자를 입력하세요." />
        <div class="sign-area">
          <label
            ...
            >서명이름</label
          >
          <div class="sign-area-input"></div>
        </div>
        <AppTextField label="비고" placeholder="비고사항을 입력하세요." />
      </VCardText>
