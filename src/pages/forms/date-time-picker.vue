...
<template>
  <VRow>
    ...
    <VCol cols="12" md="6">
      <AppCardCode title="Basic Icon Writable " :code="demoCode.basic2">
    ...
    <!-- 👉 Time Picker -->
    <VCol cols="12" md="6">
      <AppCardCode title="Time Picker" :code="demoCode.timePicker">
    ...
    <!-- 👉 Date & TIme -->
    <VCol cols="12" md="6">
      <AppCardCode title="Date and Time" :code="demoCode.dateAndTime">
    ...
    <!-- 👉 Multiple Dates -->
    <VCol cols="12" md="6">
      <AppCardCode title="Multiple Dates" :code="demoCode.multipleDates">
    ...
    <!-- 👉 Range -->
    <VCol cols="12" md="6">
      <AppCardCode title="Range" :code="demoCode.range">
    ...
    <!-- 👉 Human Friendly -->
    <VCol cols="12" md="6">
      <AppCardCode title="Human Friendly" :code="demoCode.humanFriendly">
